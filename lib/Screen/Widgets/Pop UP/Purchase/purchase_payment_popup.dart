                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          isClicked
                                              ? () async {
                                                  if (widget.transitionModel.customerType == "wfwefewf" && dueAmountController.text.toDouble() > 0) {
                                                    ...
                                                    try {
                                                      ...
                                                      try {
                                                        ...
                                                        for (var element in widget.transitionModel.productList!) {
                                                          ...
                                                          if (dataSnapshot.value == null) {
                                                            print('Product not found for code: $productCode');
                                                          ...
                                                          if (dataSnapshot.value is Map) {
                                                            (dataSnapshot.value as Map).forEach((key, productData) async {
                                                              try {
                                                                String productPath = key;
                                                                var currentStock = productData['productStock'] ?? 0;
                                                                var newStock = currentStock + element.productStock.toInt();

                                                                // Update product details in Firebase
                                                                await stockRef.child('$productPath').update({
                                                                ...
                                                                if (element.serialNumber.isNotEmpty) {
                                                                  var productOldSerialList = productData['serialNumber'] ?? [];
                                                                  List<dynamic> updatedSerials = [...productOldSerialList, ...element.serialNumber];
                                                                ...
                                                                print('Product update for $productPath completed');
                                                              } catch (e) {
                                                        ...
                                                        print('All product updates completed successfully');
                                                      } catch (e) {
                                                        print('Error updating products: $e');
                                                        // Handle overall product update error
                                                      }
                                                      ...
                                                      if (widget.transitionModel.customerName != 'wfwefef') {
                                                      ...
                                                      // GeneratePdfAndPrint()
                                                      //     .printPurchaseInvoice( purchaseTransactionModel: widget.transitionModel, context: context);
                                                      // PurchaseInvoice(
