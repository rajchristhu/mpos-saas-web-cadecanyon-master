...
class _MtHomeScreenState extends State<MtHomeScreen> {
  ...
  List<HomeReport> getLastCustomerName(List<SaleTransactionModel> model) {
    ...
    model.reversed.toList().forEach((element) {
      HomeReport report = HomeReport(element.customerName, element.totalAmount?.toStringAsFixed(2));
                                          ...
                                          children: [
                                            transactionReport.when(data: (saleReport) {
                                              return TotalCountWidget(
                                                ...
                                                changes: -5,
                                                count: calculateTotalSale(saleReport).toStringAsFixed(1),
                                              );
                                            }, error: (e, stack) {
                                              return Center(
                                            ...
                                            purchaseReport.when(data: (transaction) {
                                              return TotalCountWidget(
                                                ...
                                                changes: 4,
                                                count: calculateTotal(transaction).toStringAsFixed(1),
                                              );
                                            }, error: (e, stack) {
                                              return Center(
                                                child: Text(e.toString()),
