...
class _AddProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    gstController.text = widget.productModel.gst;
                                                      ...
                                                      onPressed: () async {
                                                        if (categoryValidateAndSave()) {
                                                          try {
                                                            ...
                                                            productModel.mrp = mrpController.text;
                                                            productModel.discount = discountController.text;
                                                            productModel.gst = gstController.text;
