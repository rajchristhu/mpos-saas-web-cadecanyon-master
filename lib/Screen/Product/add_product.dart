...
class _AddProductState extends State<AddProduct> {
  ...
  void addCategoryShowPopUp(
      ...
      required BuildContext addProductContext}) {
                          ...
                          Container(
                            ...
                            if (categoryValidateAndSave()) {
                              ...
                              try {
                                ...
                                categoryName.add(itemCategoryController.text);
                                // setState1(() {
  ...
  TextEditingController mrpController = TextEditingController(text: '');
                                          ...
                                          child: Form(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(height: 20.0),      ///________Manufacturer_______________________________________________
                                                Row(
                                                  children: [
                                                    Expanded(
                                                      child: TextFormField(
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                              ...
                                                              setState(() {
                                                                ...
                                                                productQuantityController
                                                                    ...
                                                                    ? productQuantityController
                                                                        ...
                                                                        '1'
                                                                    : productQuantityController
                                                                        .text = (num.parse(productQuantityController.text) +
                                                                            1)
                                                                        .toString();
                                                              });
                                                              productSerialNumberController
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        if (!productSerialNumberController
                                                            .text
                                                            .trim()
                                                            .isEmptyOrNull) {
                                                          if (isSerialNumberUnique(
                                                            ...
                                                            setState(() {
                                                              ...
                                                              productQuantityController
                                                                  ...
                                                                  : productQuantityController
                                                                          .text =
                                                                      (num.parse(productQuantityController.text) +
                                                                              1)
                                                                          .toString();
                                                            });
                                                            productSerialNumberController
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          productQuantityController.text == '1'
                                                                              ...
                                                                              : productQuantityController.text = (num.parse(productQuantityController.text) - 1).toString();
                                                                        });
                                                                      },
                                                                      child:
                                                                          const Icon(
...
print("enka varuthu");
                                                        if (validateAndSave()) {
                                                          print("if kulla enka varuthu");

                                                          try {
                                                            print("try kulla enka varuthu");
                                                  ...
                                                  ButtonGlobalWithoutIcon(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      if (pickedFile != null) {
                                                        ...
                                                        Uint8List list =  pickedFile.files.single.bytes!;
                                                          ...
                                                          for (var row in excel.tables[table]!.rows) {
                                                            Future.delayed(const Duration(milliseconds: 1000), () async {
                                                                ...
                                                                try {
                                                                  ...
                                                                  productModel =
                                                                  ProductModel(
                                                                    gst:row[6]!.value.toString(),
                                                                    productName:row[2]!.value.toString(),
                                                                    discount: row[7]!.value.toString(),
                                                                    mrp:row[12]!.value.toString(),
                                                                    productCategory:
                                                                        'General',
                                                                    size:
                                                                    sizeController
                                                                    ...
                                                                    selectedBrand ??
                                                                        '',
                                                                    productCode:row[8]!.value.toString(),
                                                                    productStock:"100",
                                                                    productUnit:
                                                                    selectedUnit ??
                                                                        '',
                                                                    productSalePrice:row[5]!.value.toString(),
                                                                    productPurchasePrice:row[9]!.value.toString(),
                                                                    productDiscount:row[7]!.value.toString(),
                                                                    productWholeSalePrice:row[12]!.value.toString(),
                                                                    productDealerPrice:row[12]!.value.toString(),
                                                                    productManufacturer:
                                                                    productManufacturerController
                                                                        .text,
                                                                    productPicture:
                                                                    ...
                                                                    nsnsacController
                                                                        .text,
                                                                    serialNumber:[row[8]?.value.toString()],
                                                                  );
                                                                  await productInformationRef
                                                                      .push()
                                                                      .set(productModel
