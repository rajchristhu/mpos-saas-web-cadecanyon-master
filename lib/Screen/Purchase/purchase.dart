...
class _PurchaseState extends State<Purchase> {
  ...
  String getTotalAmount() {
    num total = 0.0;
    for (var item in cartList) {
      total = total + (num.parse(item.productPurchasePrice) * num.parse(item.productStock));
    }
                            ...
                            GestureDetector(
                              onTap: () {
                                if (validateAndSave()) {
                                  ...
                                  cartList[index].mrp = editMrpPrice.toString();
                                  cartList[index].discount = editDiscountPrice.toString();
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context, consumerRef, __) {
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              productList.when(data: (product) {
                                ...
                                return Center(
                                  child: Text(e.toString()+"kdnvn dvnjdnvn"),
                                );
                              }, loading: () {
                                return const Center(
                                  child: CircularProgressIndicator(),
                          ...
                          Row(
                            ...
                            children: [
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text(
                                                        "$currency ${num.parse(getTotalAmount()) - discountAmount}",
                                                    ...
                                                    () async {
                                                        if (cartList.isEmpty) {
                                                          ...
                                                          PurchaseTransactionModel transitionModel = PurchaseTransactionModel(
                                                            ...
                                                            invoiceNumber: Random.secure().toString(),
                              ...
                              Consumer(
                                builder: (_, ref, watch) {
                                  ...
                                  return categoryList.when(data: (category) {
                                    ...
                                    return Center(
                                      child: Text(e.toString()+"ergnermgkemrgkmekrgm"),
                                    );
                                  }, loading: () {
                                    return const Center(
                                      child: CircularProgressIndicator(),
                              ...
                              productList.when(data: (products) {
                                              ...
                                              return Container(
                                                ...
                                                setState(() {
                                                  ProductModel product = ProductModel(
                                                    ...
                                                    gst: showProductVsCategory[i].gst,
                                                    mrp: showProductVsCategory[i].mrp,
                                                    discount: showProductVsCategory[i].discount,
                                ...
                                return Center(
                                  child: Text(e.toString()+"sfsfsggg"),
                                );
                              }, loading: () {
                                return const Center(
                                  child: CircularProgressIndicator(),
        ...
        //     error: (e, stack) {
        //   return Center(
        //     child: Text(e.toString()+"imkegm km ekgm kmgkm"),
        //   );
        // }, loading: () {
