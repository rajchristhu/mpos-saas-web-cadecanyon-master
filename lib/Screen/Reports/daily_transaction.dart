                            ...
                            children: [
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      reTransaction.first.remainingBalance.toStringAsFixed(1),
                            ...
                            child: DataTable(
                              ...
                              rows: List.generate(
                                ...
                                (index) => DataRow(cells: [
                                  ...
                                  DataCell(
                                    Text(reTransaction[index].total.toStringAsFixed(1), style: kTextStyle.copyWith(color: kGreyTextColor)),
                                  ),
                                  DataCell(
                                    Text(reTransaction[index].paymentIn.toStringAsFixed(1) == '0' ? '' : reTransaction[index].paymentIn.toStringAsFixed(1),
                                        style: kTextStyle.copyWith(color: Colors.green)),
                                  ),
                                  DataCell(
                                    Text(reTransaction[index].paymentOut.toStringAsFixed(1) == '0' ? '' : reTransaction[index].paymentOut.toStringAsFixed(1),
                                        style: kTextStyle.copyWith(color: Colors.red)),
                                  ),
                                  DataCell(
                                    Text(reTransaction[index].remainingBalance.toStringAsFixed(1)),
                                  ),
                                  DataCell(
                                    PopupMenuButton(
                                          ...
                                          child: GestureDetector(
                                            onTap: () async {
                                              if (reTransaction[index].type == 'Sale') {
                                                ...
                                                GeneratePdfAndPrint().printPurchaseInvoice( purchaseTransactionModel: reTransaction[index].purchaseTransactionModel!);
                                                // PurchaseInvoice(
