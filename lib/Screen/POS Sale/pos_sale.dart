...
Text("Search by name "),
                          ...
                          //                       const Spacer(),
                          //                       SizedBox(
                          //                         width: context.width() < 1080 ? 1080 * .09 : MediaQuery.of(context).size.width * .09,
                          //                         child: Padding(
                          ...
                          //                   const SizedBox(height: 10.0),
                          //
                          //                   ///___________Vat___________________________________
                          //                   Row(
                          //                     mainAxisAlignment: MainAxisAlignment.end,
                          //                     children: [
                          //                       SizedBox(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            'Total Item: ${cartList.length}',
                                            style: kTextStyle.copyWith(color: Colors.black,fontSize: 23, fontWeight: FontWeight.bold),
                                          ),
                                          const Spacer(),
                                          SizedBox(
                                            width: context.width() < 1080 ? 1080 * .09 : MediaQuery.of(context).size.width * .09,
                                            child: Padding(
                                              ...
                                              child: Text(
                                                lang.S.of(context).subTotal,
                                                textAlign: TextAlign.end,
                                                style: kTextStyle.copyWith(color: kTitleColor, fontSize: 23.0,fontWeight: FontWeight.bold),
                                              ),
                                            ),
                                          ),
                                          SizedBox(
                                            ...
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: Text(
                                                  '$currency ${(getTotalAmount().toDouble() + serviceCharge - discountAmount + vatGst + sgst + igst).toStringAsFixed(1)}',
                                                  style: kTextStyle.copyWith(color: Colors.red, fontSize: 32.0, fontWeight: FontWeight.bold),
                                                ),
                                              ),
                                            ),
                                          ),
