              ...
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Text(
                        saleTransactionModel.customer.customerAddress,
                        maxLines: 1,
                        style: pw.TextStyle(
                          fontSize: 10,
                          color: PdfColor.fromHex("#000000"),
                            ...
                            child: pw.Row(
                              children: [
                                ...
                                pw.Expanded(
                                  ...
                                  pw.Text(
                                    '${saleTransactionModel.cgst.toString()} ',
                                    style: pw.TextStyle(
                                      fontSize: 9,
                                      color: PdfColor.fromHex("#000000"),
                                      fontWeight: pw.FontWeight.normal,
                                  ...
                                  pw.Text(
                                    '${saleTransactionModel.sgst.toString()} ',
                                    style: pw.TextStyle(
                                      fontSize: 9,
                                      color: PdfColor.fromHex("#000000"),
                                      fontWeight: pw.FontWeight.normal,
                                      ...
                                      pw.Text(
                                    '${saleTransactionModel.productList![index].quantity} x Rs. ${saleTransactionModel.productList![index].subTotal}',
                                    style: pw.TextStyle(
                                      fontSize: 9,
                                      color: PdfColor.fromHex("#000000"),
                                      fontWeight: pw.FontWeight.normal,
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Center(
                        child: pw.Text(
                          "\u00a9 ${DateTime.now().year} Velan Store, All right reserved",
                          maxLines: 1,
                          style: pw.TextStyle(
                            fontSize: 7.5,
                            color: PdfColor.fromHex("#000000"),
