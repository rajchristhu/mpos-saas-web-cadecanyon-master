                                                      ...
                                                      Container(
                                                        ...
                                                        if (data[index].subscriptionPrice > 0) {
                                                          ...
                                                          var paymentUrl = await paypalRepo.getPaymentUrl(
                                                              planName: data[index].subscriptionName,
                                                              amount: data[index].subscriptionPrice.toString(),
                                                              siteUrl: Uri.base.toString());

                                                          if (paymentUrl == '${Uri.base.toString()}/cancel') {
                                                            EasyLoading.showError('Error accord');
                                                          } else {
                                                          ...
                                                          await PaymentSuccess.updateSubscription(constUserId, data[index].subscriptionName, context);
                                                        }
                                                      }).visible(
