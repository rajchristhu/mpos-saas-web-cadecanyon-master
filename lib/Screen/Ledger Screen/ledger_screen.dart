                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      '$currency${customer.type == 'Supplier' ? totalPurchase.toString() : totalSale.toString()}',
                                      style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold, fontSize: 18.0),
                                    ),
                                    Text(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      '$currency${customer.type == 'Supplier' ? totalPaid.toString() : totalReceive.toString()}',
                                      style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold, fontSize: 18.0),
                                    ),
                                    Text(
                                ...
                                ? List.generate(
                                    ...
                                    (index) {
                                      return DataRow(cells: [
                                        ...
                                        DataCell(
                                          Text(purchaseTransitions[index].totalAmount.toString(), style: kTextStyle.copyWith(color: kGreyTextColor)),
                                        ),
                                        DataCell(
                                          Text(purchaseTransitions[index].dueAmount.toString(), style: kTextStyle.copyWith(color: kGreyTextColor)),
                                        ),
                                        DataCell(
                                          ...
                                          PopupMenuButton(
                                            ...
                                            itemBuilder: (BuildContext bc) => [
                                              PopupMenuItem(
                                                child: GestureDetector(
                                                  onTap: () async {
                                                    await GeneratePdfAndPrint().printPurchaseInvoice(purchaseTransactionModel: purchaseTransitions[index]);
                                                    // SaleInvoice(
                                                    //   isPosScreen: false,
